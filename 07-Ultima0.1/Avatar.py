...
class Avatar :
    ...
    def __init__(self, x, y, hp, damage, torch):
        ...
        self.HP = hp               # health of avatar
        self.damage = damage       # how much damage the avatar can do
    ...
    # Returns HP of avatar
    def getHitPoints(self):
        return self.HP

    # Lowers health by damage taken
    def incurDamage(self, damage):
        self.HP -= damage

    # Returns how much damage the avatar deals
    def getDamage(self):
        return self.damage
